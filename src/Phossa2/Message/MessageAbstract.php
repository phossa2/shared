...
namespace Phossa2\Message;

use Phossa2\Base\StaticAbstract;
use Phossa2\Message\Mapping\MappingTrait;
use Phossa2\Message\Mapping\MappingInterface;
use Phossa2\Message\Loader\LoaderAwareInterface;
use Phossa2\Message\Formatter\FormatterAwareTrait;
use Phossa2\Message\Formatter\FormatterAwareInterface;
 ...
 *
 *   ```php
 *   use Phossa2\Message\MessageAbstract
 *
